...
SWORD Steer_PWM[4]={0,0,0,0};//舵机输出值记录
...
//	else if(Slope==2)				{Steer_kp=8;Steer_kd=5;}
	...
	if(ABS(target_offset)<6) 	{Steer_kp=30;Steer_kd=5;}
	else if(ABS(target_offset)<20)  {Steer_kp=25.2+target_offset*target_offset/100;Steer_kd=10;}
	else {Steer_kp=35.8+target_offset*target_offset/500;Steer_kd=5;}
